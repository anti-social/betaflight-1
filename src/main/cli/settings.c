...
// PG_FAILSAFE_CONFIG
    ...
    { "failsafe_delay_multiplier",  VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 1, 10 }, PG_FAILSAFE_CONFIG, offsetof(failsafeConfig_t, failsafe_delay_multiplier) },
...
// PG_OSD_CONFIG
    ...
    { "osd_kaboom_pos",             VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_KABOOM]) },
...
// PG_MODE_ACTIVATION_CONFIG
    ...
    { "kaboom_pulse_time_ms", VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 1000}, PG_KABOOM_CONFIG, offsetof(kaboomConfig_t, pulse_time_ms) },
};
